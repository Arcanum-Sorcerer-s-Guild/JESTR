...
const samGeoObject = {
	...
	geometry: {
		'type': 'Point',
		'coordinates': [-146.44166473513687, 64.31714411488758]
	},
	'properties': {
		'name': 'Test Object'
	}
...
const samGeoObject2 = {
	...
	geometry: {
		'type': 'Point',
		'coordinates': [-147.44166473513687, 65.31714411488758]
	},
	'properties': {
		'name': 'Test Object'
	}
        ...
        <Layers>
          ...
          />
					<VectorLayer
							...
							/>
					<KMLVectorLayer
							source={vector({ features: new GeoJSON().readFeatures(samGeoObject2, {featureProjection: get('EPSG:3857') }) })}
							/>
