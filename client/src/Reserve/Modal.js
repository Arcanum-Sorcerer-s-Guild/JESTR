...
const Modal = ({isvisible, onClose, children}) => {
    ...
    return ( 
        <div id='wrapper' className="fixed overflow-scroll inset-0 bg-black bg-opacity-25 backdrop-blur-sm  justify-center items-center text-center p-5" onClick={handleClose}>
