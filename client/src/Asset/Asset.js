...
//icons
import { AiOutlineNumber, AiFillSchedule, AiFillCloseCircle, AiFillCheckCircle } from 'react-icons/ai';
      ...
      {currAsset !== undefined ? (
        <div className="container mx-auto h-screen">
          <div className="flex justify-center px-6 mt-2">
            <div className="w-full h-screen block shadow-lg p-5 my-5 rounded-lg bg-text">
              {/* cardItem */}
              <div className="relative block overflow-hidden border border-gray-light shadow-xl bg-text rounded-lg ml-6 mr-6 p-4">
                <span className="absolute inset-x-0 bottom-0 h-2 bg-gradient-to-r from-green via-blue to-pink" />
                <div className="">
                  <div className="grid grid-cols-1 sm:grid-cols-4">
                    <div className="flex flex-col items-center p-8 sm:px-4 sm:h-full sm:justify-center">
                      <img
                        alt={`${params.id}`}
                    ...
                    <div className="flex flex-col sm:border-l col-span-3">
                      <div className="flex flex-col space-y-4 px-6 text-gray">
                        <div>
                          <h5 className="text-xl text-gray-dark/80 font-bold uppercase">
                        ...
                        <div className="status">
                          ...
                          <div className="flex flex-row text-xs mt-2">
                            <p className="flex items-center text-gray">
                              ...
                              <span className={`text-text px-1 rounded-full bg-gray`}>{`${currAsset.Status}`}</span>
                            </p>
                          </div>
                          ...
                          <div className="flex flex-row text-xs mt-2">
                            <p className="flex items-center text-gray">
                              ...
                              <span className='text-lg ml-1'>{currAsset.Operational ? <AiFillCheckCircle className='text-green'/> : <AiFillCloseCircle className='text-red/60'/> }</span>
                            </p>
                          </div>
                          <div className="flex flex-row text-xs mt-2">
                            <p className="flex items-center text-gray">
                              ...
                              <span className='text-lg'>{currAsset.Schedulable ? <AiFillCheckCircle className='text-green'/> : <AiFillCloseCircle className='text-red/60'/> }</span>
                            </p>
                          </div>
                        </div>
                        <div className="flex w-full border-t text-xs">
            ...
            {/* slider content */}
            <div className="h-3/12 flex flex-row gap-5 mb-4 justify-center">
              ...
              {/* <div className="w-1/6 block rounded-lg bg-bluer/25 border border-black text-center overflow-hidden flex flex-row">
                ...
                <div className="w-1/5 block rounded-lg bg-bluer/25 border border-black text-center overflow-hidden flex flex-row">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div>
                      {`Operational:`}
                      {currAsset.Operational ? <>✔️</> : <>❌</>}
                    </div>
                    <div>
                      {`Schedulable:`}
                      {currAsset.Schedulable ? <>✔️</> : <>❌</>}
                    </div>
                  </div>
                </div> */}
              ...
              <div className="flex flex-col gap-5 w-1/2 mr-10">
                ...
                <div className="flex flex-row h-full gap-5">
                  ...
                  <div className="w-1/2 h-full block rounded-lg">
                    {/* <img
                        alt={`${params.id}`}
                        src={`http://localhost:3000/images/${(params.id % 10).toString()}.jpg`}
